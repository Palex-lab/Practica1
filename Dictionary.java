public abstract class Dictionary {
    ...
    public final static int INSERT = 50;//POL
    //public final static int INSERT = 65;//ALEXIS
    public final static int DELETE = 51;
    ...
    public final static int TECLA_DELETE = 2008;
   ...
   // public final static String ANSI_INSERT = "\033[1@";
    public final static String ANSI_INSERT = "\033[2~";
